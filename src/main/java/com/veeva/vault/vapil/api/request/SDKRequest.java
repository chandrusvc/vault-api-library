 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#managing-vault-java-sdk-code">https://developer.veevavault.com/api/25.1/#managing-vault-java-sdk-code</a>
 */
public class SDKRequest extends VaultRequest<SDKRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-single-source-code-file' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-single-source-code-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#enable-or-disable-vault-extension' target='_blank'>https://developer.veevavault.com/api/25.1/#enable-or-disable-vault-extension</a>
	 * @vapil.request <pre>
	 * SDKResponse resp = vaultClient.newRequest(SDKRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#add-or-replace-single-source-code-file' target='_blank'>https://developer.veevavault.com/api/25.1/#add-or-replace-single-source-code-file</a>
	 * @vapil.request <pre>
	 * SDKResponse resp = vaultClient.newRequest(SDKRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-single-source-code-file' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-single-source-code-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#validate-imported-package' target='_blank'>https://developer.veevavault.com/api/25.1/#validate-imported-package</a>
	 * @vapil.request <pre>
	 * ValidatePackageResponse resp = vaultClient.newRequest(SDKRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-queues' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-queues</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-queue-status' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-queue-status</a>
	 * @vapil.request <pre>
	 * QueueResponse resp = vaultClient.newRequest(SDKRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#disable-delivery' target='_blank'>https://developer.veevavault.com/api/25.1/#disable-delivery</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#enable-delivery' target='_blank'>https://developer.veevavault.com/api/25.1/#enable-delivery</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#reset-queue' target='_blank'>https://developer.veevavault.com/api/25.1/#reset-queue</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-signing-certificate' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-signing-certificate</a>
	 * @vapil.request <pre>
	 * VaultResponse resp = vaultClient.newRequest(SDKRequest.class)

 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#retrieve-all-security-policies">https://developer.veevavault.com/api/25.1/#retrieve-all-security-policies</a>
 */
public class SecurityPolicyRequest extends VaultRequest<SecurityPolicyRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-security-policy-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-security-policy-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-security-policies' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-security-policies</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-security-policy' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-security-policy</a>
	 * @vapil.request <pre>

 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#expected-document-lists">https://developer.veevavault.com/api/25.1/#expected-document-lists</a>
 */
public class EDLRequest extends VaultRequest<EDLRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-a-placeholder-from-an-edl-item' target='_blank'>https://developer.veevavault.com/api/25.1/#create-a-placeholder-from-an-edl-item</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-root-nodes' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-root-nodes</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-specific-root-nodes' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-specific-root-nodes</a>
	 * @vapil.request <pre>
	 * List&lt;EDLNode&gt; resp = vaultClient.newRequest(EDLRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-a-node-s-children' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-a-node-s-children</a>
	 * @vapil.request <pre>
	 * List&lt;EDLNode&gt; resp = vaultClient.newRequest(EDLRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-node-order' target='_blank'>https://developer.veevavault.com/api/25.1/#update-node-order</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#add-edl-matched-documents' target='_blank'>https://developer.veevavault.com/api/25.1/#add-edl-matched-documents</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#remove-edl-matched-documents' target='_blank'>https://developer.veevavault.com/api/25.1/#remove-edl-matched-documents</a>
	 * @vapil.request <pre>
	 * EDLMatchedDocumentResponse resp = vaultClient.newRequest(EDLRequest.class)
	 *     .setContentTypeJson() or .setContentTypeCSV()
	 *     .setInputPath(inputFilePath)

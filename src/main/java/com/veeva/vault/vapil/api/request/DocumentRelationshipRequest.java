 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#document-relationships">https://developer.veevavault.com/api/25.1/#document-relationships</a>
 */
public class DocumentRelationshipRequest extends VaultRequest<DocumentRelationshipRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-type-relationships' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-type-relationships</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-relationships' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-relationships</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-relationship' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-relationship</a>
	 * @vapil.request <pre>
	 * DocumentRelationshipRetrieveResponse response = vaultClient.newRequest(DocumentRelationshipRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-single-document-relationship' target='_blank'>https://developer.veevavault.com/api/25.1/#create-single-document-relationship</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-multiple-document-relationships' target='_blank'>https://developer.veevavault.com/api/25.1/#create-multiple-document-relationships</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-single-document-relationship' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-single-document-relationship</a>
	 * @vapil.request <pre>
	 * DocumentRelationshipResponse response = vaultClient.newRequest(DocumentRelationshipRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-multiple-document-relationships' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-multiple-document-relationships</a>
	 */

 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#jobs">https://developer.veevavault.com/api/25.1/#jobs</a>
 */
public class JobRequest extends VaultRequest<JobRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-job-histories' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-job-histories</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-job-monitors' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-job-monitors</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-job-status' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-job-status</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * GET /api/{version}/services/jobs/{job_id}/tasks</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-sdk-job-tasks' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-job-tasks</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * GET /api/{version}/services/jobs/{job_id}/tasks</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-job-tasks' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-job-tasks</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#start-job' target='_blank'>https://developer.veevavault.com/api/25.1/#start-job</a>
	 * @vapil.request <pre>

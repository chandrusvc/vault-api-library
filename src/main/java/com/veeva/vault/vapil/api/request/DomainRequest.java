...
public class DomainRequest extends VaultRequest<DomainRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-domain-information' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-domain-information</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-domains' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-domains</a>
	 * @vapil.request <pre>

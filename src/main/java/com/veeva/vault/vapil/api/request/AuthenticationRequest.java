 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#authentication">https://developer.veevavault.com/api/25.1/#authentication</a>
 */
public class AuthenticationRequest extends VaultRequest<AuthenticationRequest> {
	 ...
	 * @vapil.api <pre>
	 * GET /api</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-api-versions' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-api-versions</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#user-name-and-password' target='_blank'>https://developer.veevavault.com/api/25.1/#user-name-and-password</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#oauth-2-0-openid-connect' target='_blank'>https://developer.veevavault.com/api/25.1/#oauth-2-0-openid-connect</a>
	 */
     ...
     * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#authentication-type-discovery' target='_blank'>https://developer.veevavault.com/api/25.1/#authentication-type-discovery</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#session-keep-alive' target='_blank'>https://developer.veevavault.com/api/25.1/#session-keep-alive</a>
     * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#validate-session-user' target='_blank'>https://developer.veevavault.com/api/25.1/#validate-session-user</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-delegations' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-delegations</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#initiate-delegated-session' target='_blank'>https://developer.veevavault.com/api/25.1/#initiate-delegated-session</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#end-session' target='_blank'>https://developer.veevavault.com/api/25.1/#end-session</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(AuthenticationRequest.class)
	 * 		.endSession();
	 * </pre>

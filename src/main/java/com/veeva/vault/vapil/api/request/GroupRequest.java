 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#domain-information">https://developer.veevavault.com/api/25.1/#domain-information</a>
 */
public class GroupRequest extends VaultRequest<GroupRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-group-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-group-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-groups' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-groups</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-group' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-group</a>
	 * @vapil.request <pre>
	 * GroupRetrieveResponse resp = vaultClient.newRequest(GroupRequest.class)
	 * 				.setIncludeImplied(includeImplied)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-group' target='_blank'>https://developer.veevavault.com/api/25.1/#create-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-group' target='_blank'>https://developer.veevavault.com/api/25.1/#update-group</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-group' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-group</a>
	 * @vapil.request <pre>

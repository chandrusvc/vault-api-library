 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#document-templates">https://developer.veevavault.com/api/25.1/#document-templates</a>
 */
public class DocumentTemplateRequest extends VaultRequest<DocumentTemplateRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-template-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-template-metadata</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-template-collection' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-template-collection</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-template-attributes' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-template-attributes</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#download-document-template-file' target='_blank'>https://developer.veevavault.com/api/25.1/#download-document-template-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-single-document-template' target='_blank'>https://developer.veevavault.com/api/25.1/#create-single-document-template</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * POST /api/{version}/objects/documents/templates</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-multiple-document-templates' target='_blank'>https://developer.veevavault.com/api/25.1/#create-multiple-document-templates</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-single-document-template' target='_blank'>https://developer.veevavault.com/api/25.1/#update-single-document-template</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-multiple-document-templates' target='_blank'>https://developer.veevavault.com/api/25.1/#update-multiple-document-templates</a>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-basic-document-template' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-basic-document-template</a>
	 * @vapil.request <pre>
	 * DocumentTemplateResponse response = vaultClient.newRequest(DocumentTemplateRequest.class)

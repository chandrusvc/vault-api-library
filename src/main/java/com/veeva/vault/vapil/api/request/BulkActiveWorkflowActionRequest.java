 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#bulk-active-workflow-actions">https://developer.veevavault.com/api/25.1/#bulk-active-workflow-actions</a>
 */
public class BulkActiveWorkflowActionRequest extends VaultRequest<BulkActiveWorkflowActionRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#initiate-workflow-actions-on-multiple-workflows' target='_blank'>https://developer.veevavault.com/api/25.1/#initiate-workflow-actions-on-multiple-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-bulk-workflow-actions-details' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-bulk-workflow-actions-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-bulk-workflow-actions' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-bulk-workflow-actions</a>
	 * @vapil.request <pre>

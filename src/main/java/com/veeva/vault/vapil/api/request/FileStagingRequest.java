 ...
 * </ul>
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#file-staging">https://developer.veevavault.com/api/25.1/#file-staging</a>
 */
public class FileStagingRequest extends VaultRequest<FileStagingRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#list-items-at-a-path' target='_blank'>https://developer.veevavault.com/api/25.1/#list-items-at-a-path</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#get-item-content' target='_blank'>https://developer.veevavault.com/api/25.1/#get-item-content</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-folder-or-file' target='_blank'>https://developer.veevavault.com/api/25.1/#create-folder-or-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-folder-or-file' target='_blank'>https://developer.veevavault.com/api/25.1/#update-folder-or-file</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-resumable-upload-session' target='_blank'>https://developer.veevavault.com/api/25.1/#create-resumable-upload-session</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#upload-to-a-session' target='_blank'>https://developer.veevavault.com/api/25.1/#upload-to-a-session</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#commit-upload-session' target='_blank'>https://developer.veevavault.com/api/25.1/#commit-upload-session</a>
	 * @vapil.request <pre>
	 * FileStagingJobResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#list-upload-sessions' target='_blank'>https://developer.veevavault.com/api/25.1/#commit-upload-session</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#get-upload-session-details' target='_blank'>https://developer.veevavault.com/api/25.1/#get-upload-session-details</a>
	 * @vapil.request <pre>
	 * FileStagingSessionResponse response = vaultClient.newRequest(FileStagingRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#list-file-parts-uploaded-to-session' target='_blank'>https://developer.veevavault.com/api/25.1/#list-file-parts-uploaded-to-session</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#abort-upload-session' target='_blank'>https://developer.veevavault.com/api/25.1/#abort-upload-session</a>
	 * @vapil.request <pre>
	 * VaultResponse response = vaultClient.newRequest(FileStagingRequest.class)

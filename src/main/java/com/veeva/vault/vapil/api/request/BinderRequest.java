 ...
 * Binder Requests
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#binders">https://developer.veevavault.com/api/25.1/#binders</a>
 * <p>
 * <i>Covered in other classes for ease of use:</i><br>
 * <a href="https://developer.veevavault.com/api/25.1/#binder-templates">https://developer.veevavault.com/api/25.1/#binder-templates</a>
 */
public class BinderRequest extends VaultRequest<BinderRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-binder-versions' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-binder-versions</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-version' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-version</a>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.api <pre>
	 * POST /api/{version}/objects/binders</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder-from-template' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder-from-template</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder-version' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder-version</a>
	 * @vapil.request <pre>
	 * resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#update-binder</a>
	 * @vapil.request <pre>
	 * resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#refresh-binder-auto-filing' target='_blank'>https://developer.veevavault.com/api/25.1/#refresh-binder-auto-filing</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-binder-version' target='_blank'>https://developer.veevavault.com/api/25.1/#update-binder-version</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-binder</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-binder-version' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-binder-version</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-sections' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-sections</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-version-section' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-version-section</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder-section' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder-section</a>
	 * @vapil.request <pre>
	 * <i>Example 1</i>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-binder-section' target='_blank'>https://developer.veevavault.com/api/25.1/#update-binder-section</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-binder-section' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-binder-section</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#add-document-to-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#add-document-to-bindern</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#move-document-to-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#move-document-to-bindern</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#remove-document-from-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#remove-document-from-bindern</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-relationship' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-relationship</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder-relationship' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder-relationship</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-binder-relationship' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-binder-relationship</a>
	 * @vapil.request <pre>
	 * DocumentRelationshipResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#export-binder' target='_blank'>https://developer.veevavault.com/api/25.1/#export-binder</a>
	 * @vapil.request <pre>
	 ...
	 * @return JobCreateResponse
	 * @vapil.api <pre>POST /api/{version}/objects/binders/{binder_id}/actions/export</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#export-binder-sections' target='_blank'>https://developer.veevavault.com/api/25.1/#export-binder-sections</a>
	 * @vapil.request <pre>
	 * JobCreateResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-export-results' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-export-results</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-binding-rule' target='_blank'>https://developer.veevavault.com/api/25.1/#update-binding-rules</a>
	 * @vapil.request <pre>
	 * BinderResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-binder-section-binding-rule' target='_blank'>https://developer.veevavault.com/api/25.1/#update-binder-section-binding-rule</a>
	 * @vapil.request <pre>
	 * BinderSectionResponse resp = vaultClient.newRequest(BinderRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-binder-document-binding-rule' target='_blank'>https://developer.veevavault.com/api/25.1/#update-binder-document-binding-rule</a>
	 */

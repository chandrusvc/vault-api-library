 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#picklists">https://developer.veevavault.com/api/25.1/#picklists</a>
 */
public class PicklistRequest extends VaultRequest<PicklistRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-picklists' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-picklists</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-picklist-values' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-picklist-values</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-picklist-values' target='_blank'>https://developer.veevavault.com/api/25.1/#create-picklist-values</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-picklist-value-label' target='_blank'>https://developer.veevavault.com/api/25.1/#update-picklist-value-label</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#update-picklist-value' target='_blank'>https://developer.veevavault.com/api/25.1/#update-picklist-value</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#inactivate-picklist-value' target='_blank'>https://developer.veevavault.com/api/25.1/#inactivate-picklist-value</a>
	 * @vapil.request <pre>

 ...
 * Document Events
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#document-events">https://developer.veevavault.com/api/25.1/#document-events</a>
 */
public class DocumentEventRequest extends VaultRequest<DocumentEventRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-event-types-and-subtypes' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-event-types-and-subtypes</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-event-subtype-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-event-subtype-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-document-event' target='_blank'>https://developer.veevavault.com/api/25.1/#create-document-event</a>
	 * @vapil.response <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-events' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-events</a>
	 * @vapil.request <pre>

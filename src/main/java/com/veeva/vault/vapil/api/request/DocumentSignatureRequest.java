 ...
 * Document Events
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#document-signatures">https://developer.veevavault.com/api/25.1/#document-signatures</a>
 */
public class DocumentSignatureRequest extends VaultRequest<DocumentSignatureRequest> {
     ...
     * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-archived-document-signature-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-archived-document-signature-metadata</a>
     * @vapil.request <pre>
     * DocumentSignatureMetadataResponse response = vaultClient.newRequest(DocumentSignatureRequest.class)

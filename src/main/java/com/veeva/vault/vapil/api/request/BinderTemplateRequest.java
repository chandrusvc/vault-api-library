 ...
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#binder-templates">https://developer.veevavault.com/api/25.1/#binder-templates</a>
 */
public class BinderTemplateRequest extends VaultRequest<BinderTemplateRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-template-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-template-metadata</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-template-node-metadata' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-template-node-metadata</a>
	 * @vapil.request <pre>
	 * BinderTemplateMetadataResponse response = vaultClient.newRequest(BinderTemplateRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-template-collection' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-template-collection</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-template-attributes' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-template-attributes</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-binder-template-node-attributes' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-binder-template-node-attributes</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder-template' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder-template</a>
	 * @vapil.request <pre>
	 * BinderTemplateResponse response = vaultClient.newRequest(BinderTemplateRequest.class)
	 ...
	 * @vapil.api <pre>
	 * POST /api/{version}/objects/binders/templates</pre>
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#bulk-create-binder-templates' target='_blank'>https://developer.veevavault.com/api/25.1/#bulk-create-binder-templates</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#bulk-update-binder-templates' target='_blank'>https://developer.veevavault.com/api/25.1/#bulk-update-binder-templates</a>
	 */
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#delete-binder-template' target='_blank'>https://developer.veevavault.com/api/25.1/#delete-binder-template</a>
	 * @vapil.request <pre>
	 * BinderTemplateResponse resp = vaultClient.newRequest(BinderTemplateRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#create-binder-template-node' target='_blank'>https://developer.veevavault.com/api/25.1/#create-binder-template-node</a>
	 * @vapil.request <pre>
	 * BinderTemplateResponse response = vaultClient.newRequest(BinderTemplateRequest.class)
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#replace-binder-template-nodes' target='_blank'>https://developer.veevavault.com/api/25.1/#replace-binder-template-nodes</a>
	 * @vapil.request <pre>
	 * BinderTemplateNodeBulkResponse response = vaultClient.newRequest(BinderTemplateRequest.class)
	 * 				.setInputPath(filePath)

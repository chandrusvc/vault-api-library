 ...
 * workflows.
 *
 * @vapil.apicoverage <a href="https://developer.veevavault.com/api/25.1/#retrieve-all-document-workflows">https://developer.veevavault.com/api/25.1/#retrieve-all-document-workflows</a>
 */
public class DocumentWorkflowRequest extends VaultRequest<DocumentWorkflowRequest> {
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-all-document-workflows' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-all-document-workflows</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#retrieve-document-workflow-details' target='_blank'>https://developer.veevavault.com/api/25.1/#retrieve-document-workflow-details</a>
	 * @vapil.request <pre>
	 ...
	 * @vapil.vaultlink <a href='https://developer.veevavault.com/api/25.1/#initiate-document-workflow' target='_blank'>https://developer.veevavault.com/api/25.1/#initiate-document-workflow</a>
	 * @vapil.request <pre>
